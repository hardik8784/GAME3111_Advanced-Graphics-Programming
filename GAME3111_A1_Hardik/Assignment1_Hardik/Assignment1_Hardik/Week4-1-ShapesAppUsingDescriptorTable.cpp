//***************************************************************************************
// ShapesApp.cpp 
//Assignment 1 HARDIK SHAH (Student ID : 101249099)
...
void ShapesApp::BuildRenderItems()
{
    ...
    leftFrontTower->IndexCount = leftFrontTower->Geo->DrawArgs["cylinder"].IndexCount;
    leftFrontTower->StartIndexLocation = leftFrontTower->Geo->DrawArgs["cylinder"].StartIndexLocation;
    leftFrontTower->BaseVertexLocation = leftFrontTower->Geo->DrawArgs["cylinder"].BaseVertexLocation;
    ...
    leftBackTower->IndexCount = leftBackTower->Geo->DrawArgs["cylinder"].IndexCount;
    leftBackTower->StartIndexLocation = leftBackTower->Geo->DrawArgs["cylinder"].StartIndexLocation;
    leftBackTower->BaseVertexLocation = leftBackTower->Geo->DrawArgs["cylinder"].BaseVertexLocation;
    ...
    RightBackTower->IndexCount = RightBackTower->Geo->DrawArgs["cylinder"].IndexCount;
    RightBackTower->StartIndexLocation = RightBackTower->Geo->DrawArgs["cylinder"].StartIndexLocation;
    RightBackTower->BaseVertexLocation = RightBackTower->Geo->DrawArgs["cylinder"].BaseVertexLocation;
    ...
    RightFrontTower->IndexCount = RightFrontTower->Geo->DrawArgs["cylinder"].IndexCount;
    RightFrontTower->StartIndexLocation = RightFrontTower->Geo->DrawArgs["cylinder"].StartIndexLocation;
    RightFrontTower->BaseVertexLocation = RightFrontTower->Geo->DrawArgs["cylinder"].BaseVertexLocation;
